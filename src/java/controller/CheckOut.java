...
public class CheckOut extends HttpServlet {
            ...
            if (isCurrentAddress) {
                ...
                if (c1.list().isEmpty()) {
                    responseObject.addProperty("message",
                            "Current address is not found. Please add a new address");
                } else {
    ...
    private void processCheckout(Session s, Transaction tr, User user, Address address, JsonObject responseObject) {
        ...
        try {
            ...
            //Payhere Process
            String merchantID = "1224184";
            String merchantSecret = "MzkwMzQzOTA2MTExODkwNDY3OTkyMTI3MTM5MDgwMjE3MDM5NDQ4NA==";
            String orderID = "#00" + orderId;
            String currency = "USD";
            ...
            payHereJson.addProperty("notify_url", "https://3ea448b98fcc.ngrok-free.app/GlamNest/VerifyPayments");
